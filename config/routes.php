...
$routes = [
    ...
    '/gestaoLoja/cadastroSubCategoria' => 'CategoriaController@telaCadastrarSubCategoria',
    '/gestaoLoja/cadastrarSubcategoriaDatabase' => 'subCategoriaController@cadastroSubCategoria',
    ...
    '/gestaoLoja/dashboardPedidos' => 'PedidosController@telaGeralPedidos',
    '/gestaoLoja/pedidosRealizados' => 'PedidosController@telaPedidosRealizados',
    '/gestaoLoja/atualizarPedidos' => 'PedidosController@telaAtualizarPedidos',
    '/gestaoLoja/pedidosEntregues' => 'PedidosController@telaPedidosEntregues',
