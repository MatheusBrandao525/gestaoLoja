...
<div class="main">
    ...
    <div class="container-pedidos-realizados">
        <div class="header-pedidos">
            <h1>Atualizar Status de Entrega dos Pedidos</h1>
        </div>
        <div class="order-summary">
            <span>Total de Entregas em Andamento: 15</span>
        </div>
        <div class="search">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>R$ 100,00</td>
                    <td>22-05-2024</td>
                    <td><span class="status approved">A Caminho</span></td>
                    <td>
                        <button class="btn btn-detail">Detalhes</button>
                        <button class="btn btn-edit">Editar</button>
                        <button class="btn btn-delete">Excluir</button>
                        <button class="btn btn-despachar">Atualizar Entrega</button>
                    </td>
                </tr>
                <tr>
                    <td>2</td>
                    ...
                    <td>R$ 15,00</td>
                    <td>21-05-2024</td>
                    <td><span class="status despachado">Despachado</span></td>
                    <td>
                        <button class="btn btn-detail">Detalhes</button>
                        <button class="btn btn-edit">Editar</button>
                        <button class="btn btn-delete">Excluir</button>
                ...
                <tr>
                    ...
                    <td>R$ 140,00</td>
                    <td>22-05-2024</td>
                    <td><span class="status separacao">Em Separação</span></td>
                    <td>
                        <button class="btn btn-detail">Detalhes</button>
                        <button class="btn btn-edit">Editar</button>
                        <button class="btn btn-delete">Excluir</button>
