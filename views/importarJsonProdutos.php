...
<div class="main">
    ...
    <div class="coluna-inteira">
        ...
        <div class="coluna-inteira">
            ...
            <form action="importarImagensProduto" method="POST" enctype="multipart/form-data"
                class="image-upload-form">
                <div class="row">
                    <div class="column">
                        <div class="image-upload-wrapper">
                            <input type="file" id="image-upload-file" hidden="hidden" name="imageUpload[]" multiple
                                required>
