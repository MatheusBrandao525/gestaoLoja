...
<div class="main">
    <div class="busca-produtos">
        <input type="text" id="busca" placeholder="Digite o nome ou código do produto..." onkeyup="pesquisaProdutos()">
    </div>
                ...
                <div class="produto-info">
                    ...
                    <div class="produto-opcoes">
                        <form action="editarProduto" method="post">
                            ...
                            <button type="submit" class="btn-editar-produto"
                                data-produto-id="<?php echo $produto['produto_id']; ?>">Editar</button>
                        </form>
                        <button class="btn-excluir-produto"
                            data-produto-id="<?php echo $produto['produto_id']; ?>">Excluir</button>
                    </div>
                </div>
            </div>
            <?php } ?>
